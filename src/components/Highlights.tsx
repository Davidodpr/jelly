...
const testimonials = [
  ...
  },
  {
    ...
    name: "Erik N.",
    role: "CEO",
    title: "Moving Smarter, Not Harder",
    quote: "We were drowning in manual quotes and missed leads. Jellymove automated our entire sales funnel and identified costs we didn't even know we had. Now we close more moves with half the admin work.",
    results: [
      'Revenue +50%',
