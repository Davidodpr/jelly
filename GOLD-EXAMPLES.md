# Jellymove Brain - Guld-exempel

För att lära AI:n att tänka som Jellymove. Dessa är facit.

**Principer:**
- Affär, inte hemsida
- De 5 linserna: Subtract, Access, Price, Friction, Automate
- Ton: Kaxig, varm, direkt. Glimten i ögat.

---

## Exempel 1: SaaS för Byggbranschen
...
- **Action:** Skapa en "Strategi-Sprint": kort format, avgränsad deliverable, tydligt pris. Bevisar värde snabbt. De som gillar det konverterar till stora projekt.

### Play 2 (Access - Existing Customers)
- **Icon:** 📞
...
- **Action:** Spela in en video som förklarar hur ni jobbar och ungefärlig prisrange. Skicka innan möte. De som fortfarande bokar är seriösa.

---

## Exempel 4: Kaffeprenumeration
...
### Play 2 (Subtract - Acquisition Channel)
- **Icon:** ✂️
...
- **Action:** Erbjud en "smakresa" över flera månader med tema varje leverans. Kunden committar längre, du får flera gånger LTV innan churn-risken.

---

## Sammanfattning: Lins-fördelning

| Exempel | Play 1 | Play 2 | Play 3 |
|---------|--------|--------|--------|
| Byggapp | Access (Community) | Subtract (Segment) | Price (Cashflow) |
| Solceller | Access (OPP) | Price (Recurring) | Subtract (Channel) |
| Konsult | Friction (Entry) | Access (Customers) | Automate (Qualification) |
| Kaffe | Access (B2B) | Subtract (Channel) | Price (Commitment) |

---

## Användning

Dessa exempel tränar AI:n att:
1. Tänka affär, inte taktik
2. Hitta oanvända tillgångar (Access)
3. Våga säga "sluta med X" (Subtract)
4. Utmana prismodellen (Price)
5. Identifiera onödig friktion (Friction)
6. Peka på automatisering (Automate)

Tonen ska vara en coach som ser vad du missar - inte en konsult som skriver rapport.
